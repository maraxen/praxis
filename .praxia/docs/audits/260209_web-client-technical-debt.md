---
title: 'Web-client technical debt log (Feb 2026)'
description: 'Web-client debt entries from Feb 2026, starting with replacing DeckCatalogService''s hardcoded deck-type matching with programmatic PyLabRobot detection'
status: archived
